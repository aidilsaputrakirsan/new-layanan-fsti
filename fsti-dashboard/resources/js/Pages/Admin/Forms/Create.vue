...
function handleAddField(type) {
    ...
    form.schema.fields.push(newField)
...
function handleSaveField(updatedField) {
    const index = form.schema.fields.findIndex(f => f.id === updatedField.id)
    if (index !== -1) {
        form.schema.fields[index] = updatedField
    }
}

function handleDeleteField(fieldId) {
    const index = form.schema.fields.findIndex(f => f.id === fieldId)
    if (index !== -1) {
...
<template>
    ...
    <div>
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-2xl font-bold">Buat Form Baru</h1>
        </div>
                    ...
                    >
                        ...
                        <NSpace vertical class="w-full">
                            ...
                            <Link href="/admin/forms">
                                <NButton block :disabled="form.processing">
                                    Batal
                                </NButton>
                            </Link>
                        </NSpace>
